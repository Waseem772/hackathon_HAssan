...
import { MdDarkMode, MdOutlineBloodtype } from "react-icons/md";
    ...
    >
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          {/* LOGO xs flex */}
          <GiBloodyStash className="cursor-pointer text-2xl mr-1 items-center flex customScr:hidden" />
          <Typography
            variant="h5"
            noWrap
            sx={{
            ...
            >
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Stack alignItems={"center"}>
                  <Avatar alt="Bloody" src="" />
                  <Typography>Bloody</Typography>
