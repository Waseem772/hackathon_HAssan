...
import { signUPFun } from "../config/firebaseAuthMethod";
...
export const SignUp = () => {
  ...
  const filterGroup = bloodGroups.find((obj) => obj.value == selectedGroups);
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    signUPFun({ ...signUp,bloodGroup: filterGroup.bloodGroup });
    ...
    //       // sendData({ ...signUp,bloodGroup: filterGroup.bloodGroup }, user.uid)
          ...
          <form onSubmit={onSubmit} className="p-2">
            ...
            <div className="flex items-center space-x-2">
              <Input_field
                ...
                classname="mx-2"
                startAdornment={<SiNamecheap className="text-lg" />}
              />
              <Input_field
            ...
            <Input_field
              ...
              input_value={input_value}
              classname="mx-2 my-1"
              startAdornment={<MdDateRange className="text-lg" />}
            />
            ...
            <Input_field
              ...
              input_value={input_value}
              classname="mx-2 my-1"
              startAdornment={<MdMarkEmailUnread className="text-lg" />}
            />
            ...
            <Input_field
              ...
              input_value={input_value}
              classname="mx-2 my-1"
              startAdornment={<TbPasswordUser className="text-lg" />}
            />
